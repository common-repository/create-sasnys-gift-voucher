...
use schweikert\CSS\CSSList\KeyFrame;
use schweikert\CSS\Value\Size;
use schweikert\CSS\Property\Selector;
use schweikert\CSS\RuleSet\DeclarationBlock;
use schweikert\CSS\Property\AtRule;
use schweikert\CSS\Value\URL;
use schweikert\CSS\Parsing\UnexpectedTokenException;
...
body {color: green;}', $oDoc->render());
	...
	function testRuleGetters() {
		...
		$this->assertSame(true, $aHeaderRules['background-color']->getValue() instanceof \schweikert\CSS\Value\Color);
...
#unrelated {other: yes;}', $oDoc->render());
	...
	/**
	* @expectedException schweikert\CSS\Parsing\OutputException
	*/
...
body {background-url: url("http://somesite.com/images/someimage.gif");}';
	...
	/**
	* @expectedException schweikert\CSS\Parsing\UnexpectedTokenException
	*/
	...
	*/
	...
	function testLineNumbersParsing() {
		...
		$aExpected = array(
			1 => array('schweikert\CSS\Property\Charset'),
			3 => array('schweikert\CSS\Property\CSSNamespace'),
			5 => array('schweikert\CSS\RuleSet\AtRuleSet'),
			11 => array('schweikert\CSS\RuleSet\DeclarationBlock'),
			// Line Numbers of the inner declaration blocks
			17 => array('schweikert\CSS\CSSList\KeyFrame', 18, 20),
			23 => array('schweikert\CSS\Property\Import'),
			25 => array('schweikert\CSS\RuleSet\DeclarationBlock')
		);
	...
	/**
	 * @expectedException \schweikert\CSS\Parsing\UnexpectedTokenException
	 * Credit: This test by @schweikert (from https://github.com/schweikert/PHP-CSS-Parser/pull/105#issuecomment-229643910 )
	 */
